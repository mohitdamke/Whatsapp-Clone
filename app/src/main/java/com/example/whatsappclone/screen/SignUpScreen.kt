    ...
    LazyColumn {
        item {
            Column(
                ...
                Log.d("TAG", "SignUpScreen:${FirebaseAuth.getInstance().currentUser?.uid} ")
                Image(
                ...
                Spacer(modifier = Modifier.padding(top = 20.dp))
                Text(text = "Sign up", fontSize = 40.sp, fontWeight = W600)
                Spacer(modifier = Modifier.padding(top = 20.dp))
                OutlinedTextField(
                    value = name,
                ...
                Spacer(modifier = Modifier.padding(top = 20.dp))
                Text(text = "Already have an account?", fontWeight = W400, fontSize = 18.sp)
                Spacer(modifier = Modifier.padding(top = 20.dp))
                Button(onClick = {
